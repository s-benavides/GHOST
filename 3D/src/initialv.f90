...
! - curl(C1,C2,C3) = (vx,vy,vz)
! - Have: |C| = 1/kf so that |u| = u0 in the end.
! - Isotropic 
      ...
      ! Sets largest mode forcing to zero
         ...
         DO j = 2,ny/2+1
            ...
            IF ((kk2(1,j,1).le.kup**2).and.(kk2(1,j,1).ge.tiny)) THEN
         ...
         DO k = 2,nz/2+1
            ...
            IF ((kk2(k,1,1).le.kup**2).and.(kk2(k,1,1).ge.tiny)) THEN
         ...
         DO j = 2,ny
            ...
            IF ((kk2(k,j,1).le.kup**2).and.(kk2(k,j,1).ge.tiny)) THEN
         ...
         DO i = 2,iend
            DO j = 1,ny
               ...
               IF ((kk2(k,j,i).le.kup**2).and.(kk2(k,j,i).ge.tiny)) THEN
